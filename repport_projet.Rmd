...
En regarder les statistiques descriptives, nous remarquons que les valeurs de la méthode pmm se rapproche plus des vraies valeurs. 
...
Nous avons utilisé la méthode du Bootstrap pour voir s'il y a une amélioration de la condition physique chez les patients en faisant une comparaison de moyenne en T0 et T1 sur la variable RMSSD.
