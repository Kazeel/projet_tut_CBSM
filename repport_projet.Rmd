...
Avec le SVM, nous obtenons une très bonne accuracy (proche de 90% selon l'hyper paramètre). C'est un excellent résultat dans notre cas.
...
plot(roc(predictor=predict(m_glm_loo,merge_data,type="prob")$yes,
               response=merge_data$progress,
               levels=rev(levels(merge_data$progress))))
```
